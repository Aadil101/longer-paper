...
\begin{table}
  ...
  \begin{tabular}{c|c|c|c}
    ...
    \hline
  \end{tabular}
  \caption{\label{tab:gigaword_breakdown} Breakdown of Gigaword articles by newswire. Note that for each newswire, articles are grouped together in specific files. Total Words denotes the total number of whitespace-separated tokens across all articles of a given newswire.}
\end{table}
