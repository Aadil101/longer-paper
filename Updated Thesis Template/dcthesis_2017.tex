...
\begin{table}
  \centering
  \begin{tabular}{>{\centering\arraybackslash}p{0.2\linewidth}>{\centering\arraybackslash}p{0.8\linewidth}}
    ...
    \texttt{is\_acronynm} & Boolean for whether the target word is a sequence of capital letters.\\
  \end{tabular}
...
\begin{table}
  \centering
  \begin{tabular}{>{\centering\arraybackslash}p{0.3\linewidth}>{\centering\arraybackslash}p{0.7\linewidth}}
    \textbf{Feature} & \textbf{Description} \\ 
...
\begin{table}
  \centering
  \begin{tabular}{>{\centering\arraybackslash}p{0.4\linewidth}>{\centering\arraybackslash}p{0.6\linewidth}}
    \textbf{Feature} & \textbf{Description} \\ 
...
\begin{table}
  ...
  \begin{tabular}{>{\centering\arraybackslash}p{0.3\linewidth}>{\centering\arraybackslash}p{0.7\linewidth}}
    ...
    \texttt{tf\_summed\_bpe} & Sum of the term frequencies of each BPE of the target word. BPE tokenization is performed using Huggingface's BERT Tokenizer.\\
...
\begin{table}
  ...
  \begin{tabular}{>{\centering\arraybackslash}p{0.3\linewidth}>{\centering\arraybackslash}p{0.7\linewidth}}
    \textbf{Feature} & \textbf{Description} \\ 
    \texttt{parse\_tree\_depth} & Height of the context's constituency parse tree. The tree is obtained using a Stanford CoreNLP pipeline.\\
    ...
    \texttt{is\_proper} & Boolean for whether the target word is a proper noun/adjective. This is detected simply based on capitalization.\\
    \texttt{POS\_LS, POS\_TO, POS\_VBN, POS\_WP, POS\_UH, POS\_VBG, POS\_JJ, POS\_VBZ, POS\_VBP, POS\_NN, POS\_DT, POS\_PRP, POS\_WP\$, POS\_NNPS, POS\_PRP\$, POS\_WDT, POS\_RB, POS\_RBR, POS\_RBS, POS\_VBD, POS\_IN, POS\_FW, POS\_RP, POS\_JJR, POS\_JJS, POS\_PDT, POS\_MD, POS\_VB, POS\_WRB, POS\_NNP, POS\_EX, POS\_NNS, POS\_SYM, POS\_CC, POS\_CD, POS\_POS} & Booleans for whether the target word part-of-speech tag is such. Tags considered include those used in the Penn Treebank Project.\tablefootnote{\url{https://www.ling.upenn.edu/courses/Fall_2003/ling001/penn_treebank_pos.html}} Tags are estimated using NLTK's \texttt{pos\_tag} method.\\
  \end{tabular}
